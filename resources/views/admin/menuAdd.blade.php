...
@section('table')
    <form class="layui-form" action="javascript:;" enctype="multipart/form-data" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="path" autocomplete="off" placeholder="请输入路径"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="display_name" lay-verify="required" autocomplete="off" placeholder="请输入菜单名称"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="description" lay-verify="required" autocomplete="off" placeholder="当前名称 or  顶级 > 当前菜单名称"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="icon" lay-verify="required" autocomplete="off" placeholder="请输入图标样式"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sort" lay-verify="required" value="10" autocomplete="off" placeholder="请输入路径"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script src="{{asset('admin/js/menuAdd.js')}}"></script>